...
import com.ponthaitay.lifecycleactivity.googleio2017.lifecycle.kotlincode.MainActivity
...
open class MainMenuActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            R.id.btn_lifecycle_activity -> intent = Intent(this, MainActivity::class.java)
            R.id.btn_live_data_activity -> intent = Intent(this, MainLiveDataActivity::class.java)
            R.id.btn_room_activity -> intent = Intent(this, MainActivity::class.java)
            R.id.btn_mix_activity -> intent = Intent(this, MainActivity::class.java)
        }
